...
from models.quan_resnet import QCNNCeleba
from models.quan_update import LocalUpdate
...
if __name__ == '__main__':
    ...
    elif args.model == 'qcnn' and args.dataset == 'celeba':
        net_glob = QCNNCeleba(args=args).to(args.device)
    elif args.model == 'mlp':
        len_in = 1
        for x in img_size:
            len_in *= x
